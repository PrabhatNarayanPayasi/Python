# ye ek function hai jo kisi function ko leke usme kuch modification karke dobara se return kar deta hai use.
# ye ek simple wrapper function hota hai which is used to modify any function without changing them directly
#  iska common use hota hai validation logging ya timing me 
def greet(function):
    def fx():
        print("is it ok");
        function()
...
methods, by modifying its behavior without modifying the source code.
