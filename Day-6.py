...
# Very similar to how our containers in kitchen holds sugar, salt etc Creating a variable is like creating a placeholder in memory and assigning it some value. In Python its as easy as writing:
...
# name = "Pravbhat"
# print(type(name))
# list = [2,3,4,5,"shiva" ,(5+3) , [4-2]];
# print(list);
# print(type(list))
# tuple = (1,2,3,4,"hello",(6-3),[7-2])
# print(tuple[0]);
# print(type(tuple))
# print(len(tuple))
DICTIONARY = {"Name":"Prabhat" , "Age":"19"}
